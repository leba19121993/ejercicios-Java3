...
//        
        ...
        System.out.println("\nMediante la herencia de la clase Ave, se obtiene que el aguila: ");
        System.out.println("Pertenece a la especie:"+aguila.getEspecie2());
        System.out.println("A la clase Aguila se puede decir si esta domesticada:");
        System.out.println(aguila.enCautiverio(true));
        System.out.println("O no está domesticada:");
        System.out.println(aguila.enCautiverio(false));
        System.out.println("\nMediante la clase Ave, se obttiene que el aguila:");
        System.out.println(""+aguila.volar(50));
        System.out.println("La capacidad de cazar: "+aguila.cazar2(false));
        System.out.println("La capacidad de saber si esta vivo: "+aguila.vivir2(aguila));
